...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            // Insert new schedule
            $query = "INSERT INTO schedules (departure_date, return_date, available_slots, status, 
                      airline, route, departure_day, duration_days, created_at) 
                      VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())";
            ...
            // Log activity
            logActivity('ADD_SCHEDULE', "Menambahkan jadwal baru: $airline - $route");
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-calendar-plus me-2"></i>Tambah Jadwal Keberangkatan</h5>
            </div>
            <div class="card-body">
                <?php if (isset($error)): ?>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" id="return_date" name="return_date" 
                                   value="<?php echo $_POST['return_date'] ?? ''; ?>" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="airline" name="airline" 
                                   value="<?php echo htmlspecialchars($_POST['airline'] ?? ''); ?>" 
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="departure_day" name="departure_day">
                                ...
                                <option value="SENIN" <?php echo ($_POST['departure_day'] ?? '') == 'SENIN' ? 'selected' : ''; ?>>Senin</option>
                                <option value="SELASA" <?php echo ($_POST['departure_day'] ?? '') == 'SELASA' ? 'selected' : ''; ?>>Selasa</option>
                                <option value="RABU" <?php echo ($_POST['departure_day'] ?? '') == 'RABU' ? 'selected' : ''; ?>>Rabu</option>
                                <option value="KAMIS" <?php echo ($_POST['departure_day'] ?? '') == 'KAMIS' ? 'selected' : ''; ?>>Kamis</option>
                                <option value="JUMAT" <?php echo ($_POST['departure_day'] ?? '') == 'JUMAT' ? 'selected' : ''; ?>>Jumat</option>
                                <option value="SABTU" <?php echo ($_POST['departure_day'] ?? '') == 'SABTU' ? 'selected' : ''; ?>>Sabtu</option>
                                <option value="MINGGU" <?php echo ($_POST['departure_day'] ?? '') == 'MINGGU' ? 'selected' : ''; ?>>Minggu</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="available_slots" name="available_slots" 
                                   value="<?php echo $_POST['available_slots'] ?? 45; ?>" min="0" max="999" required>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="duration_days" name="duration_days" 
                                   value="<?php echo $_POST['duration_days'] ?? 12; ?>" min="1" max="30">
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-select" id="status" name="status" required>
                                ...
                                <option value="full" <?php echo ($_POST['status'] ?? '') == 'full' ? 'selected' : ''; ?>>Full</option>
